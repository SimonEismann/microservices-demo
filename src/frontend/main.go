...
var (
	...
	logLevel              = flag.String("logLevel", "debug", "log level from debug, info, warning, error. When debug, generate 100% Tracing")
...
func main() {
	...
	r.HandleFunc("/cart/{id}", svc.viewCartHandler).Methods(http.MethodGet, http.MethodHead)
